...
app.get('/',function(req,res){
    // res.send('Welcome');
	res.render('user.html',{title:"Nueva version con Angular",data:0});
});
...
curut.get(function(req,res,next){
    ...
    req.getConnection(function(err,conn){
        ...
        var query = conn.query('SELECT * FROM t_user',function(err,rows){
            ...
            // res.render('user.html',{title:"RESTful Crud Ejemplo",data:rows});
			console.log(rows); 
			res.json(rows);
         });
...
curut2.get(function(req,res,next){
    ...
    req.getConnection(function(err,conn){
        ...
        var query = conn.query("SELECT * FROM t_user WHERE user_id = ? ",[user_id],function(err,rows){
            ...
            res.render('edit.html',{title:"Edit user",data:rows});
        });
